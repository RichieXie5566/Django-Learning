...
ALLOWED_HOSTS = ['django-learning-production-fe4a.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['https://django-learning-production-fe4a.up.railway.app']
...
DATABASES = {
    'default': {
        ...
        'NAME':'railway',
        'USER':'postgres',
        'PASSWORD':os.environ['DB_PASSWORD_RE'],
